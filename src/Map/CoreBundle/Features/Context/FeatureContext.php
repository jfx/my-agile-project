...
use Map\CoreBundle\Features\Context\UtilSubcontext;
use Map\UserBundle\Features\Context\LoginSubcontext;
...
class FeatureContext extends MinkContext implements KernelAwareInterface
{
    ...
    public function __construct(array $parameters)
    {
        ...
        $this->useContext('util', new UtilSubcontext($parameters));
        $this->useContext('view', new ViewSubcontext($parameters));
        $this->useContext('table', new TableSubcontext($parameters));
